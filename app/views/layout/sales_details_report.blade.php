				...
				<div class="col-xs-12">
				    <div class="box dark">
				        ...
				        <div id="div-1" class="body collapse in" aria-expanded="true">
				        	...
				        	<div class="col-xs-12">
				        		<div class="alert alert-success">تقرير ارباح وخساير <button type="button" class="btn btn-default pull-right" onclick="printDiv('.reportHolder');">طباعة</button>
			        			<div style="clear:both;"></div>

				        		</div>
			        			<div style="clear:both;"></div>
					        	{{Form::open(["action" => "showSalesDetailReport","id"=>"showSalesDetailReport" ,"class"=>"form-horizontal"])}}
					                <div class="col-xs-6">
...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#showSalesDetailReport").on("submit",function(){
			var formElementsData = new FormData(this);
			$.ajax({
				url : "showSalesDetailReport",
				dataType : 'json',
				type : 'post',
				contentType: false,
				processData: false,
				...
				success : function(data){
					if (data.errorsFounder == 1){
						...
						$.each(data.total_payment_details,function(k,v){
							...
							reportDrawer += "<td>"+ parseFloat(v.total_sold).toFixed(2) +"</td>";
							reportDrawer += "<td>صافي الربح أو خسارة</td>";
							reportDrawer += "<td>"+ parseFloat(v.total_revenu).toFixed(2) +"</td>";
							reportDrawer += "</tr>";
						});
						reportDrawer += "</table>";
						...
						reportDrawer += "<th>صافي ربح الفواتير</th>";
